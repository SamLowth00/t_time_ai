...
import { fetchTeeTimes, type TeeTime } from "../api/intelligentgolf";
import TeeTimeTable from "../components/TeeTimeTable";
import VendorTabs from "../components/VendorTabs";

export default function IntelligentgolfPage() {
      ...
      <div className="mx-auto max-w-3xl space-y-6">
        <header>
          ...
          <p className="text-sm text-gray-600">
            Paste an IntelligentGolf <code>/visitorbooking/</code> URL, pick a
            date, and choose a party size.
          </p>
        </header>
        ...
        >
          <div>
            ...
            <input
              ...
              placeholder="https://tankersley.intelligentgolf.co.uk/visitorbooking/"
